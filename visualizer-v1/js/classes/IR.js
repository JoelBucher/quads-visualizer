export class IR{
    ...
    add(sir){
        ...
        switch(axis){
            case 'x':
                pos[0] == this.maxCorner[0] ? this.maxCorner[0]++ : {}
                break
            case 'y':
                pos[1] == this.maxCorner[1] ? this.maxCorner[1] = parseInt(this.maxCorner[1]) + 1 : {}
                break
            case 'z':
                pos[2] == this.maxCorner[2] ? this.maxCorner[2]++ : {}
                break
        }
